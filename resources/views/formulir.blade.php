            ...
            <div class="card-body">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" required name="tempat_lahir" placeholder="tempat"
                            aria-label="tempat">
                        <span class="input-group-text">/</span>
                        <input type="date" class="form-control" required name="tanggal_lahir" placeholder="tanggallahir"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" required name="nohp_ayah" id="nohp">
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row mb-3">
                        <label for="nohp" class="col-sm-2 col-form-label">nohp</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" required name="nohp_ibu" id="nohp">
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-10">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="gridCheck1" required name="required"
                                    required>
