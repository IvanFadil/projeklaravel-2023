                        ...
                        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                            ...
                            <div class="offcanvas-body">
                                <ul class="navbar-nav nav-pills flex-column justify-content-end flex-grow-1 ">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link active link-light" style="background-color: #0A1212;" href="cetakkartu"><i class="bi bi-printer"></i> Cetak
                                            Kartu Pendaftaran</a>
                                    </li>
                                    <li class="nav-item">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row  mt-5">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4 mb-5">
                                <button class="btn link-light me-md-2" style="background-color: #0A1212;" type="button"> Cetak </button>
