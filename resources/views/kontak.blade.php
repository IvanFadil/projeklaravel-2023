        ...
        <div class="row">
                        ...
                        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                            ...
                            <div class="offcanvas-body">
                                <ul class="navbar-nav nav-pills flex-column justify-content-end flex-grow-1 ">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link " href="pengumuman"><i class="bi bi-megaphone"></i>
                                            Pengumuman Penerimaan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active link-light " style="background-color: #0A1212;"
                                            href="kontak"><i class="bi bi-person-lines-fill"></i> Kontak Kami</a>
                                    </li>
            ...
            <div class="col-lg-9 mt-2 ">
                <div class="card text-center">
                    <div class="card-body ">
                        <h1 class="card-title mt-5 mb-5 ">Kontak Kami</h1>
                        <pre class="h6 text-start mb-5">
    Kepala Sekolah : RAHMAYANI <br/>
    Operator Data Akademik : ZULFIRA, S.Pd.I <br/>
    Nomor Telepon : Belum Tersedia <br/>
    Nomor Fax : <br/>
    Email : <br/>
    Website : http:// <br/>
